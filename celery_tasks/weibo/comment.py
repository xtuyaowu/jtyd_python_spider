...
def crawl_comment_page(mid):
    ...
    for page_num in range(2, limit):
        Celery.send_task('celery_tasks.comment.crawl_comment_by_page', args=(mid, page_num), queue='comment_page_crawler',
...
def excute_comment_task():
    ...
    for weibo_data in weibo_datas:
        Celery.send_task('celery_tasks.comment.crawl_comment_page', args=(weibo_data.weibo_id,), queue='comment_crawler',
