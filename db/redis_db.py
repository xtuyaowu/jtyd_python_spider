...
class Cookies(object):
    ...
    @classmethod
    def store_cookies(cls, name, cookies, source, adver_timers):
        pickled_cookies = json.dumps(
            {'cookies': cookies, 'loginTime': datetime.datetime.now().timestamp(),
             'source': source, 'adver_timers': adver_timers + 1})
    ...
    def fetch_cookies_of_normal(cls):
        ...
        for i in range(cls.rd_con.llen('account_queue')):
            ...
            if j_account:
                ...
                return name, account['cookies'], account['source'], account['adver_timers']
        return None
    ...
    def fetch_cookies_of_quick(cls):
        ...
        if my_cookies_name:
            ...
            if not cls.check_cookies_timeout(my_cookies):
                ...
                return my_cookies_name, my_cookies['cookies'], my_cookies['source'], my_cookies['adver_timers']
            else:
